...
class LapSorting
{
  ...
  {
   List<Laptops> l =  Arrays.asList(new Laptops(8000, 8, "black"), new Laptops(7000, 9, "grey"), new Laptops(5000, 7, "yellow"));
   System.out.println("Naturally sorted Laptop list according to Laptop Ram : ");
   List<Laptops> ll = l.stream().sorted(Comparator.comparing(Laptops::getLapRam)).collect(Collectors.toList());
